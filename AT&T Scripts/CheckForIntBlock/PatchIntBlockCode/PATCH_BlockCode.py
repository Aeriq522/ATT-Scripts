...
def update_plans(subscriber_data):
    subscriber_number, headers, addOfferingCode = subscriber_data
    url = "https://apsapi.att.com:8082/sp/mobility/lineconfig/api/v1/service/" + subscriber_number
    
    data = {
        "serviceCharacteristic": [
            {"name": "addOfferingCode", "value": addOfferingCode},
        ]
    }
...
csv_file = "C:/Users/eriks/AppData/Local/Programs/Python/Python312/Scripts/AT&T Scripts/CheckForIntBlock/PatchIntBlockCode/addOfferingCode.csv"
output_file = "C:/Users/eriks/AppData/Local/Programs/Python/Python312/Scripts/AT&T Scripts/CheckForIntBlock/PatchIntBlockCode/addOfferingCode_result.csv"
